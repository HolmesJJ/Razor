<script>
  module.exports = {
    ...
    methods: {
      ...
      renderMsg(h){
        return (<rz-card activated={false} class="notify-content">
          <div class="notify-content__header">
             <span class="notify-content__header--btn" onClick={this.close}>关闭</span>这是一条通知消息
          </div>
          <div class="notify-content__content">
            <rz-image
              src={this.src}
              width="60"
              height="80"
            ...
            <div class="notify-content__content--left">
              <h3>欧阳锋</h3>
              <p>2019-9-26</p>
            </div>
          </div>
