<template>
  <transition name="rz-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="rz-time-range-picker rz-picker-panel rz-popper"
      :class="popperClass"
    >
      <div class="rz-time-range-picker__content">
        <div class="rz-time-range-picker__cell">
          <div class="rz-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="rz-time-range-picker__body rz-time-panel__content"
          >
            <time-spinner
              ref="minSpinner"
        ...
        <div class="rz-time-range-picker__cell">
          <div class="rz-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="rz-time-range-picker__body rz-time-panel__content"
          >
      ...
      <div class="rz-time-panel__footer is-range">
        <rz-button
          type="info"
          class="rz-time-panel__btn cancel"
          @click="handleCancel()"
        >{{ t('el.datepicker.cancel') }}</rz-button>
        <rz-button
          type="primary"
          class="rz-time-panel__btn confirm"
          @click="handleConfirm()"
