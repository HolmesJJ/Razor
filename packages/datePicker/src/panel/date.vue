<template>
  <transition name="rz-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="rz-picker-panel rz-date-picker rz-popper"
      :class="[{
      ...
      <div class="rz-picker-panel__body-wrapper">
        ...
        <div class="rz-picker-panel__body">
          <div class="rz-date-picker__time-header" v-if="showTime">
            <span class="rz-date-picker__editor-wrap">
              <rz-input
            ...
            <span class="rz-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <rz-input
                ref="input"
          ...
          <div
            class="rz-date-picker__header"
            :class="{ 'rz-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              v-show="currentView === 'year' || currentView === 'month'"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="rz-picker-panel__icon-btn rz-date-picker__prev-btn rz-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="rz-picker-panel__icon-btn rz-date-picker__prev-btn rz-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="rz-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="rz-date-picker__header-label"
            ...
            <button
              ...
              class="rz-picker-panel__icon-btn rz-date-picker__next-btn rz-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="rz-picker-panel__icon-btn rz-date-picker__next-btn rz-icon-arrow-right">
            </button>
          </div>

          <div class="rz-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
export default {
  ...
  components: {
    TimePicker, YearTable, MonthTable, DateTable, RzInput, RzButton
  },
