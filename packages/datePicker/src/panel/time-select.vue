<template>
  ...
  >
    <div
      ...
      :class="popperClass"
      class="rz-picker-panel time-select rz-popper"
    >
      <rz-scrollbar noresize wrap-class="rz-picker-panel__content">
        <div
...
export default {
  ...
  methods: {
    ...
    scrollToOption(selector = ".selected") {
      const menu = this.$refs.popper.querySelector(".rz-picker-panel__content");
