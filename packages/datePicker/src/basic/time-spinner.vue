<template>
  <div class="rz-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <rz-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="rz-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="rz-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="rz-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="rz-time-spinner__arrow rz-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="rz-time-spinner__arrow rz-icon-arrow-down"></i>
        <ul class="rz-time-spinner__list" ref="hours">
          <li
            class="rz-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="rz-time-spinner__arrow rz-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="rz-time-spinner__arrow rz-icon-arrow-down"></i>
        <ul class="rz-time-spinner__list" ref="minutes">
          <li
            class="rz-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="rz-time-spinner__arrow rz-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="rz-time-spinner__arrow rz-icon-arrow-down"></i>
        <ul class="rz-time-spinner__list" ref="seconds">
          <li
...
import RepeatClick from 'rz/directive/repeat-click';
