import { hasClass, addClass, removeClass } from 'rz/utils/dom';
...
export default {
                  ...
                  this._l(columns, (column, cellIndex) =>
                    <th
                      ...
                      <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                        ...
                        {
                          column.filterable
                            ? <span class="rz-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['rz-icon-arrow-down', column.filterOpened ? 'rz-icon-arrow-up' : ''] }></i></span>
                            : ''
                        }
                      </div>
                    </th>
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.rz-table__column-filter-trigger') || cell;
