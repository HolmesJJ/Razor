<script>
import { isDef } from "rz/utils/shared";
  ...
  render(h) {
    ...
    const menus = this._l(activeOptions, (menu, menuIndex) => {
      ...
      const items = this._l(menu, item => {
        ...
        return (
          <li
            class={{
              "rz-cascader-menu__item": true,
              "rz-cascader-menu__item--extensible": item.children,
      ...
      return (
        <ul
          class={{
            "rz-cascader-menu": true,
            "rz-cascader-menu--flexible": isFlat
          }}
          {...hoverMenuEvent}
          onMousemove={isHoveredMenu ? hoverMenuHandler : voidFn}
          style={menuStyle}
          refInFor
          ref="menus"
          role="menu"
    ...
    return (
      ...
      >
        <div
          v-show={visible}
          class={["rz-cascader-menus rz-popper", popperClass]}
          ref="wrapper"
        >
          {menus}
        </div>
