...
<style>
.demo-block .demo-carousel.demo-flex-carousel-container{
  display:flex;
}
.demo-block .demo-carousel .block {
  padding: 30px;
  text-align: center;
...
.demo-block .demo-carousel .block:last-child {
  border-right: none;
}

.demo-block .demo-carousel .demonstration {
  display: block;
  color: #8492a6;
  font-size: 14px;
  margin-bottom: 20px;
...
.demo-block .demo-carousel .rz-carousel__container {
  text-align: center;
}

.demo-block .demo-carousel .rz-carousel__item {
 background:red;
}

.demo-block .demo-carousel .rz-carousel__item h3 {
  color: #fff;
  font-size: 18px;
  line-height: 150px;
  margin: 0;
}
.demo-block .demo-carousel .rz-carousel__item:nth-child(2n) {
  background-color: #99a9bf;
}
.demo-block .demo-carousel .rz-carousel__item:nth-child(2n+1) {
  background-color: #d3dce6;
}

.demo-block .demo-carousel .small h3 {
  font-size: 14px;
  line-height: 150px;
}
