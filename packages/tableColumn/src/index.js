...
import { getPropByPath } from "rz/utils/util";
...
const defaults = {
  ...
  selection: {
    ...
    realWidth: 48,
    order: "",
    className: "rz-table-column--selection"
  },
  expand: {
    width: 48,
    minWidth: 48,
  ...
  expand: {
    ...
    renderCell: function(h, { row, store }, proxy) {
      ...
      return (
        <div
          class={
            "rz-table__expand-icon " +
            (expanded ? "rz-table__expand-icon--expanded" : "")
          }
    ...
    sortable: false,
    resizable: false,
    className: "rz-table__expand-column"
  }
};
